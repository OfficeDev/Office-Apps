...
module DataViz.SKUs {
    ...
    export class SKUInstance {
        ...
        public static fromDefinition(definition: SKUDefinition): SKUInstance {
            Validate.Validator.ensures(definition).from("SKUInstance::fromDefinition").isNotNull();
            ...
            instance.plotter = Tools.ToolsFactory.buildTool(definition.plotter);
            instance.layouter = Tools.ToolsFactory.buildTool(definition.layouter);
            instance.dataBinder = Tools.ToolsFactory.buildTool(definition.dataBinder);
            instance.dataConvertor = Tools.ToolsFactory.buildTool(definition.dataConvertor);
            instance.configurator = Tools.ToolsFactory.buildTool(definition.configurator);
            ...
            instance.visualizer = new Chart.Visualizer(instance.layouter, instance.plotter);
            instance.controller = new Control.Controller(instance.visualizer, instance.dataBinder, instance.dataConvertor);
    ...
    /**
      ...
      */
    export class SKUProvider implements Config.IConfigurationChangeListener {
        ...
        private currentSKUId = "peoplebar-giant";
        ...
        public loadAll(preDefines: SKUDefinition[], callback: () => any) {
            Validate.Validator.ensures(callback).from("SKUProvider::loadAll").isNotNull();
        ...
        public get SKUs(): SKUDefinition[] {
            Validate.Validator.ensures(this.definitions).from("SKUProvider::SKUs").isNotNull();
        ...
        public set CurrentSKUId(id: string) {
            Validate.Validator.ensures(id).from("SKUProvider::CurrentSKUId")
                                          .isNotNull()
                                          .isNotEmpty();
        ...
        public onConfigurationChanged(key: string, value: any) {
            Validate.Validator.ensures(key).from("SKUProvider::onConfigurationChanged [key]")
                                           .isNotNull()
                                           .isNotEmpty();
            Validate.Validator.ensures(value).from("SKUProvider::onConfigurationChanged [key]=" + key + " [value]")
                                             .isNotNull();

            if (key === Config.wellKnownKeys.sku) {
